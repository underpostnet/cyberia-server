// Package engine_client — world_builder.go
//
...
// LoadAll performs the initial full load via GetFullInstance.
...
// ReloadWorld re-fetches the full instance and, when the version
